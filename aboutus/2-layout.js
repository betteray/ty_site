var wpAjaxUrl = 'https://wpnux.godaddy.com/wp-admin/admin-ajax.php';
var flBuilderUrl = 'https://wpnux.godaddy.com/wp-content/plugins/beaver-builder-lite-version/';
var FLBuilderLayoutConfig = {
    anchorLinkAnimations: {duration: 1000, easing: 'swing', offset: 100},
    paths: {
        pluginUrl: 'https://wpnux.godaddy.com/wp-content/plugins/beaver-builder-lite-version/',
        wpAjaxUrl: 'https://wpnux.godaddy.com/wp-admin/admin-ajax.php'
    },
...
(function ($) {
    ...
    FLBuilderLayout = {
        init: function () {
            ...
            var $element = 'undefined' == typeof element ? $('body') : $(element),
                bxContent = $element.find('.bx-viewport .fl-post-carousel-wrapper'), bxObject = null;
            if (bxContent.length) {
            ...
            var wrap = $(this), width = wrap.data('width'), height = wrap.data('height'), mp4 = wrap.data('mp4'),
                ...
                loaded = wrap.data('loaded'), fallbackTag = '', videoTag = null, mp4Tag = null, webmTag = null;
            if (loaded) {
                return;
            }
            ...
            if (typeof Vimeo !== 'undefined' && videoId) {
                player = new Vimeo.Player(videoPlayer[0], {id: videoId, loop: true, title: false, portrait: false});
            ...
            if (typeof jQuery.fn.waypoint !== 'undefined' && !FLBuilderLayout._isMobile()) {
                $('.fl-animation').each(function () {
                    var node = $(this), nodeTop = node.offset().top, winHeight = $(window).height(),
                        bodyHeight = $('body').height(), offset = '80%';
